...
#, python-format
msgid "Enter your %s"
msgstr "%s خود را وارد کنید"

msgid "Enter your email address to reset your password"
msgstr "برای بازنشانی رمز، نشانی ایمیل خود را وارد کنید"

msgid "You cannot have multiple permission records for the same collection."
msgstr "نمی‌توانید چند رکورد مجوز برای یک مجموعه معین داشته باشید."
...
msgstr "این صفحه زنده است. آیا مایلید کپی آن نیز انتشار یابد؟"

msgid "Publish copies"
msgstr "انتشار کپی‌ها"
...
msgstr "این اسلاگ در حال استفاده داخل محتوای صفحه والد خود \"%s\" است"
...
msgstr "اینجا ترجیحات آگاهسازی خودتان را ویرایش کنید:"
...
"اینجاد شده در اینجا پیش از آن که به سایت مرتبط شوند قابل دسترسی از طریق "
"نشانی اینترنتی را نخواهند داشت."
...
msgstr "صفحه والد جدیدی را برای %(title)s انتخاب کنید"

#, python-format
msgid "Select a new parent page for <span>%(title)s</span>"
msgstr "صفحه والد جدیدی را برای <span>%(title)s</span> انتخاب کنید"
...
msgstr "متاسفانه هیچ صفحه ای با «<em>%(query_string)s</em>» تطابق نداشت"
...
msgstr "ترجیحات شما بروزرسانی شد."
...
"by %(user)s"
msgstr ""
"شما در حال دیدن بازبینی قبلی این صفحه از <b>%(created_at)s</b> توسط %(user)s "
"هستید"
