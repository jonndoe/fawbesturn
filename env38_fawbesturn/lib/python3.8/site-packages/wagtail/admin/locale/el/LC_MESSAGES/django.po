...
msgstr "Δεν υπάρχουν διαφορές μεταξύ αυτών των δύο αναθεωρήσεων"
...
msgstr "Εμφάνιση της αναθεωρησης"

msgid "Compare with previous revision"
msgstr "Σύγκριση με προηγούμενη αναθεώρηση"
...
"by %(user)s"
msgstr ""
"Εμφανίζεται παλαιά αναθεώρηση της σελίδας που δημιουργήθηκε στις <b>"
"%(created_at)s</b> από το χρήστη %(user)s"
