...
msgstr "이 슬러그는 이미 상위 페이지 \"%s\" 에서 쓰이고 있습니다"
...
msgstr[0] ""
"\n"
"이 필드에는 다음의 페이지 타입만을 선택할 수 있습니다: %(type)s. 검색 결과에"
"서 다른 타입들은 제외될 것입니다."
...
msgstr "\"%(page)s\" 페이지에 대한 검토를 %(editor)s에게 신청했습니다."
...
msgstr[0] ""
"\n"
"%(descendant_count)s 개의 하위 페이지들도 삭제될 예정입니다"
...
msgstr ""
"\n"
"기존 사이트에 페이지를 추가하고 싶다면 대신 홈페이지의 하위 페이지로 생성해 "
"주세요."
...
msgstr ""
"\n"
"%(num_pages)s 페이지 중 %(page_number)s"
...
msgstr "%(title)s 를 위한 새로운 상위 페이지 선택"

#, python-format
msgid "Select a new parent page for <span>%(title)s</span>"
msgstr "<span>%(title)s</span>  를 위한 새로운 상위 페이지 선택"
...
msgstr "죄송합니다. <em>\"%(query_string)s\"</em> 와 연관된 결과가 없습니다"
...
"by %(user)s"
msgstr ""
"%(user)s 사용자가 %(created_at)s에 만든 이 페이지의 이전 수정안을 보고 있습니"
"다."
