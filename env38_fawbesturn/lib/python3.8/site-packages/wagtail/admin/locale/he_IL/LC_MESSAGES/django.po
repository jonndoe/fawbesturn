...
msgstr "בחירת עמוד הורה חדש עבור %(title)s"

#, python-format
msgid "Select a new parent page for <span>%(title)s</span>"
msgstr "בחירת עמוד הורה חדש עבור <span>%(title)s</span>"

#, python-format
msgid "Sorry, no pages match <em>\"%(query_string)s\"</em>"
msgstr "מצערים, לא נמצאו עמודים שתואמים <em>\"%(query_string)s\"</em>"
