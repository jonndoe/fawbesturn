...
<div class="wagtail-logo-container__desktop u-hidden@xs">
    <img class="wagtail-logo wagtail-logo__body" src="{% versioned_static 'wagtailadmin/images/car.svg' %}" alt=""/>
    <img class="wagtail-logo wagtail-logo__tail" src="{% versioned_static 'wagtailadmin/images/logo-eyeopen.svg' %}" alt="" />
